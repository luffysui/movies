...
<a class="fastBuyNav fastBuyNav2" id="fastBuyNav" href="javascript:;"></a>
  <div class="showLeft">
	  <h2 class="showTitle clearfix"><a class="on" href="{{ url('/onshow') }}">正在热映</a><span class="fg">/</span><a href="javascript:;" style="font-size:30px;color:#000; ">即将上映</a></h2>
	  <div class="showMain" id="playListBox">
		<div class="listSort"><span class="listSum">即将热映
				{{ $movieCount }}
	  部</span>
