                                ...
                                <ul class="entrylist">
                                    <li>
                                        <div class="entry_wrap">
                                            <div class="entry_img"><img src="{{ asset('admin/images/thumbs/image1.png') }}" alt="" /></div>
                                    ...
                                    <li class="even">
                                        <div class="entry_wrap">
                                            <div class="entry_img"><img src="{{ asset('admin/images/thumbs/image2.png') }}" alt="" /></div>
                                            <div class="entry_content">
                                    ...
                                    <li>
                                        <div class="entry_wrap">
                                            <div class="entry_img"><img src="{{ asset('admin/images/thumbs/image3.png') }}" alt="" /></div>
                                            <div class="entry_content">
                                    ...
                                    <li class="even">
                                        <div class="entry_wrap">
                                            <div class="entry_img"><img src="{{ asset('admin/images/thumbs/image4.png') }}" alt="" /></div>
                                            <div class="entry_content">
                ...
                <div class="one_third last dashboard_right">
                    ...
                    <div class="widgetbox">
                        ...
                        <div class="widgetcontent userlistwidget nopadding">
                            <ul>
                                <li>
                                    <div class="avatar"><img alt="" src="{{ asset('admin/images/thumbs/avatar1.png') }}" /></div>
                                    <div class="info">
                                        <a href="">Squint</a> <br />
                                ...
                                <li>
                                    {{--shuaxin--}}
                                    <div class="avatar"><img alt="" src="{{ asset('admin/images/thumbs/avatar2.png') }}" /></div>
                                    <div class="info">
                                        <a href="">Eunice</a> <br />
